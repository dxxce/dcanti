// Real SVG icon set (Lucide-style, MIT-equivalent paths drawn inline).
// Single stroke-based component so every icon shares size/color via CSS
// (currentColor + 1.75 stroke). Replaces all emoji across the UI.
...
const P: Record<IconName, JSX.Element> = {
  ...
  attach: <path d="M21.44 11.05l-9.19 9.19a5 5 0 0 1-7.07-7.07l9.19-9.19a3.5 3.5 0 0 1 4.95 4.95l-9.2 9.19a1.5 1.5 0 0 1-2.12-2.12l8.49-8.49" />,
  upload: <><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><polyline points="17 8 12 3 7 8" /><line x1="12" y1="3" x2="12" y2="15" /></>,
  folder: <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" />,
  folderOpen: <path d="M6 14l1.5-2.5A2 2 0 0 1 9.24 10H21a1 1 0 0 1 .95 1.3l-1.8 6A2 2 0 0 1 18.24 19H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h6a2 2 0 0 1 2 2v1" />,
  ...
  push: <><path d="M12 19V5" /><polyline points="5 12 12 5 19 12" /></>,
  pull: <><path d="M12 5v14" /><polyline points="19 12 12 19 5 12" /></>,
...
export function Icon({ name, size = 16, className, style, strokeWidth = 1.75 }: IconProps) {
  return (
    <svg
